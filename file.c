...
static int f2fs_ioc_shutdown(struct file *filp, unsigned long arg)
{
	...
	printk(KERN_INFO "f2fs_ioc_shutdown triggered\n");
	switch (in) {
...
//		printk(KERN_INFO "DYLee : f2fs_ioc_forward_sync with no force_user");
	...
	if (ret) {
//		printk(KERN_INFO "DYLee : f2fs_ioc_forward_sync BUG #2");
		return ret;
	}
	...
	if (err) {
	//	printk(KERN_INFO "DYLee : f2fs_ioc_forward_sync BUG #3");
		goto out;
	}
	...
	if (err) {
//		printk(KERN_INFO "DYLee : f2fs_ioc_forward_sync BUG #4");
		goto out;
	}
